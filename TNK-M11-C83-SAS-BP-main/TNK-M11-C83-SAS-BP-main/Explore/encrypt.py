...
# Define decrypt function that takes message and privateKey as parameters
def decrypt(ciphertext, privateKey):
    # Get privateExponent and modulus from privateKey
    privateExponent, modulus = privateKey
    # Use formula ''.join([chr((char ** privateExponent) % modulus) for char in ciphertext]) and store the results in 'plaintext' variable
